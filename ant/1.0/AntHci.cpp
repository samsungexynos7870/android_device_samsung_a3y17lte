 ...
 *
 * Adapted for the a3y17lte open-source QCA9377 stack (see shim/). The
 * IAntHci method bodies are the stock QTI implementation; the transport
 * behind them is our ANT DataHandler shim over libbt-vendor's ANT channel
 * (ant_sock served by the wcnss_filter mux daemon).
 */
